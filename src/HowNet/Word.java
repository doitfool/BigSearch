...
public class Word {
    ...
    //  获取和设置第一义原
    public String getFirstPrimitive() { return firstPrimitive;  }
    ...
    public boolean isStructruralWord(){ return !structruralWords.isEmpty(); }


    //  获取和添加关系义原
    public Map<String, List<String>> getRelationalPrimitives(){ return relationalPrimitives; }
