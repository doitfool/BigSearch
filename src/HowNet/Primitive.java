...
public class Primitive {
    ...
    /**
     * 判断词word是否是义原
     * @param word：待判断是否是义原的词
     * @param PRIMITIVESID_zh：所有义原的中文表示与ID的映射Map
     * @param PRIMITIVESID_en：所有义原的英文表示与ID的映射Map
     * @return： False表示不是义原，True表示是义原
     */
    public static boolean isPrimitive(String word, Map<String, Integer> PRIMITIVESID_zh, Map<String, Integer> PRIMITIVESID_en){
        return PRIMITIVESID_zh.containsKey(word) || PRIMITIVESID_en.containsKey(word);
    }
     ...
     */
    public  List<Integer> getParents(String primitive, Map<Integer, Primitive> ALLPRIMITIVES_zh,
                                     Map<String, Integer> PRIMITIVESID_zh, Map<String, Integer> PRIMITIVESID_en) {
